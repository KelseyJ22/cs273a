...
def classify_enhancer(df):
    ...
    enhancer_labels = labels_matrix[labels_matrix.columns[1]]
    ...
    for i, (train, test) in enumerate(kf):
        ...
        model = RandomForestClassifier().fit(X[train], [y[i] for i in train])
    ...
    plt.savefig('pickled_vista_data_brain_rf_k_6.png')
    plt.close()
